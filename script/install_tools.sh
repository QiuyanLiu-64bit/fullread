...
do
{
printf "install iperf3, wondershaper, nasm-2.15(X), isa-l(X) ....: root@192.168.7.%d\n" $i
ssh root@$IP_PREFIX$i "cd $TOOLS_DIR && unzip -oq iperf-master.zip && unzip -oq wondershaper-master.zip &&unzip -oq nasm-2.15.zip && unzip -oq isa-l.zip"
